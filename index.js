document.querySelector('#sub').addEventListener('click', () => {
    ...
    if (isNaN(first_res)) {
        cgpa1 = "At least first sem GPA needed for CGPA calculation";
    ...
    document.querySelector('.cgpacalc_output h3').innerHTML = `TOTAL CGPA : ${cgpa1}`;
})

document.querySelector('#res').addEventListener('click', () => {
    document.querySelector('.cgpacalc_output h3').innerHTML = `TOTAL CGPA : `;
